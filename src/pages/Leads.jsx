...
import { Search, Filter, Plus, X, ArrowRightLeft } from 'lucide-react';
          ...
          {data?.leads?.map((lead) => (
            <div key={lead._id} className="p-4 space-y-4">
              ...
              <div className="pt-2">
                {!lead.isConverted && (
                  <button 
                    onClick={() => { if (lead.status === 'Qualified') openConvertModal(lead); }}
                ...
                {lead.isConverted && (
                  <div className="w-full py-2.5 rounded-lg bg-green-50 text-green-700 flex items-center justify-center font-semibold text-sm shadow-sm">
                    Converted
                  </div>
                )}
              </div>
        ...
        <div className="hidden md:block overflow-x-auto">
          <table className="min-w-full divide-y divide-gray-200">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {data?.leads?.map((lead) => (
                <tr key={lead._id} className="hover:bg-gray-50 transition cursor-pointer">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                    ...
                    {lead.isConverted && (
                      <span className="text-green-600 font-medium text-xs bg-green-50 px-2 py-1 rounded-md inline-flex items-center w-full justify-center">Converted</span>
                    )}
                  </td>
                </tr>
              ))}
